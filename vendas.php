    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
          ...
          <li class="nav-item active" data-toggle="tooltip" data-placement="right" title="Example Pages">
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Carteira</li>
		...
		<div id="vendas" class="container-fluid">
		...
		<form action="_php/cadastraVenda.php" method="POST">
			
			<div class="row">
			<div class="form-group col-md-2">
				<label for="idVendas">Código</label>
				<input type="id" class="form-control" id="idVendas" name="idVendas" placeholder="" disabled>
			...
			<div class="form-group col-md-4">
				<label for="vendasVend">Vendedor</label>
					<select class="form-control" id="vendasVend" name="vendasVend">
			...
			<div class="form-group col-md-4">
				<label for="vendasCli">Cliente</label>
					<select class="form-control" id="vendasCli" name="vendasCli">
					<option>Selecione o Cliente</option>
					<!-- popular com os clientes do vendedor selecionado -->
					<?php
						popula_cli();
					?>
			...
			<div class="row">
				<div class="form-group col-md-2">
					<label for="vendasData">Data</label>
					<input type="datetime" class="form-control" id="vendasData" name="vendasData" placeholder="dd/mm/yy">
				</div>
			
				<div class="form-group col-md-2">
					<label for="vendasValor">Valor R$</label>
					<input type="number" class="form-control" id="vendasValor" name="vendasValor" placeholder="R$">
				</div>
			</div>	
