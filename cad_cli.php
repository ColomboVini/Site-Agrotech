  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
		...
		<div id="vend" class="container-fluid">
		...
		<form action="_php/cadastraCliente.php" method="POST">
			
			
			<div class="row">
				<div class="form-group col-md-2">
					<label for="codCli">Código</label>
					<input type="id" class="form-control" id="idCliente" name="id" placeholder="" disabled>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-10">
					...
					<input type="name" class="form-control" id="nomeCli" name="nomeF" placeholder="Nome Fantasia">
				</div>
			</div>
			
			<div class="row">
				<div class="form-group col-md-10">
					<label for="razaoSocCli">Razão Social</label>
					<input type="name" class="form-control" id="razaoSoc" name="razao" placeholder="Razão Social">
				</div>
			</div>
			
			<div class="row">
				<div class="form-group col-md-4">
					<label for="cnpjCli">CNPJ</label>
					<input type="name" class="form-control" id="nomeVendedor" name="cnpj" placeholder="CNPJ">
				</div>
			
				<div class="form-group col-md-4">
					<label for="ieCli">Inscrição Estadual</label>
					<input type="name" class="form-control" id="ie" name="insc" placeholder="Inscrição Estadual">
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-10">
					...
					<input type="name" class="form-control" id="endCli" name="end" placeholder="Endereço">
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group col-md-4">
					...
					<input type="name" class="form-control" id="cidadeCli" name="cidade" placeholder="Cidade">
				</div>
			
				<div class="form-group col-md-2">
					<label for="nomeVend">Estado</label>
					<select class="form-control" id="estadoCli" name="estado">
						<option>MG</option>
						<option>SP</option>
					</select>
				</div>
			...
			<div class="row">
				<div class="form-group col-md-10">
					...
					<input type="email" class="form-control" id="emailCliente" name="email" placeholder="E-Mail">
				</div>
			</div>	
				
			<div class="row">
				<div class="form-group col-md-4">
					<label for="telCli1">Telefone 1</label>
					<input type="tel1" class="form-control" id="telCliente1" name="tel1" placeholder="Telefone">
				</div>
				
				<div class="form-group col-md-4">
					<label for="telCli2">Telefone 2</label>
					<input type="tel2" class="form-control" id="telCliente2" name="tel2" placeholder="Celular">
				</div>
			</div>
			
			<div class="row">
			<div class="form-group col-md-4">
				<label for="vendCli">Vendedor</label>
					<select class="form-control" id="vendCli" name="vendCli" >
					<option>Selecione o vendedor</option>
					<!-- popular com os vendedores cadastrados-->
					<?php
					include("_php/popula.php");
					popula_vend();
					?>
			...
			<div class="form-group col-md-4">
				<label for="pagCli">Forma de Pagamento</label>
					<select class="form-control" id="pagCli" name="pag">
						<option>À Vista</option>
						<option>Cheque</option>
						<option>Boleto</option>
						<option>Notinha</option>
					</select>
			</div>
			
			<div class="form-group col-md-2">
				<label for="prazoCli">Prazo</label>
					<select class="form-control" id="prazoCli" name="prazo">
			...
			<div class="checkbox col-md-2">
				<label><input type="checkbox" value="" name="nfe">Nota Fiscal</label>
				<label><input type="checkbox" value="" name="cupom">Cupom Fiscal</label>
				<label><input type="checkbox" value="" name="xml">XML</label>
			</div>
			</div>
			-->
